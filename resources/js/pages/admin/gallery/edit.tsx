...
export default function GalleryEdit({ gallery }: GalleryEditProps) {
  ...
  // Warna icon berdasarkan kategori (sama seperti di Create)
              ...
              <CardContent className="pt-6">
                <form onSubmit={submit} className="space-y-6">
                  ...
                  >
                    ...
                    {previewImage && (
                      <p className="text-xs text-muted-foreground mt-1">Gambar baru dipilih (gambar lama akan diganti saat disimpan)</p>
                    )}
                  ...
                  {/* Category - Dropdown dengan warna */}
                  <motion.div
                    className="space-y-2"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
